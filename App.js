...
constructor(){
   ...
   analyzeDate(word,date,houseno, arr, date2) { //fx compare duration current & parcel date. then puts duration inside a 2d array
    ...
    this.state.arr[0][0][0] = 1; //bayangkan kat sini ada fx yg boleh add values to arr. 
        ...
        const { date2 } = this.state;
         ...
         <table>
          ...
          <td><td><View style={styles.button}>
                  <Button color="#1d2424" 
               title="Analyze dates"
               onPress={() => this.analyzeDate(this.state.date,this.state.houseNo) }/>
                   </View></td></td>
      
            <p>{this.state.arr[0][0][0]}</p>
            <p>{this.state.arr[0][1][0]}</p>
            <p>{this.state.arr[0][2][0]}</p>
            <p>{this.state.arr[0][3][0]}</p>
            <p>{this.state.arr[0][4][0]}</p>
            <p>{this.state.arr[1][0][0]}</p>
            <p>{this.state.arr[1][1][0]}</p>
            <p>{this.state.arr[1][2][0]}</p>
